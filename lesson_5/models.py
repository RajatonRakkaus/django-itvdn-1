...
class Flower(models.Model):
    ...
    can_use_in_bouquet = models.BooleanField(default=True, null=True)
    wiki_page = models.URLField(default='https://www.wikipedia.org', name="wikipedia", unique_for_date="delivered_at", null=True)
...
class Bouquet(models.Model):
    ...
    fresh_period = models.DurationField(default=timedelta(days=5), help_text="How long the flowers are fresh", null=True)
...
class Client(models.Model):
    ...
    discount_size = models.DecimalField(max_digits=5, decimal_places=2, null=True)
